...
export const translations: Translations = {
  ...
  'features.pos.title': { sw: 'Mauzo ya Haraka', en: 'Fast Sales' },
  'features.pos.desc': { sw: 'Rekodi mauzo kwa sekunde. Fuata malipo ya M-Pesa, Tigo Pesa, na pesa taslimu.', en: 'Record sales in seconds. Track M-Pesa, Tigo Pesa, and cash payments.' },
  'features.inventory.title': { sw: 'Hesabu ya Bidhaa', en: 'Inventory Tracking' },
  'features.inventory.desc': { sw: 'Jua bidhaa zilizopo wakati wote. Pokea arifa wakati bidhaa zinakaribia kuisha.', en: 'Know your stock levels at all times. Get alerts when products run low.' },
  'features.reports.title': { sw: 'Ripoti za Kina', en: 'Detailed Reports' },
  'features.reports.desc': { sw: 'Tazama mauzo ya siku, wiki, au mwezi. Pakua ripoti za PDF na Excel.', en: 'View daily, weekly, or monthly sales. Download PDF and Excel reports.' },
  'features.offline.title': { sw: 'Inafanya Kazi Bila Mtandao', en: 'Works Offline' },
  'features.offline.desc': { sw: 'Endelea kufanya mauzo hata bila internet. Data itasawazishwa baadaye.', en: 'Continue making sales even without internet. Data syncs later.' },
