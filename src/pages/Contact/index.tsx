              ...
              <div className="space-y-8">
                ...
                <div className="space-y-4">
                  ...
                  {contactInfo.map((info, index) => {
                    ...
                    return (
                      <a
                        key={index}
                        href={info.link}
                        className="flex items-start gap-4 p-6 pb-14 card-kokotoa rounded-xl hover:border-primary/30 transition-all group relative overflow-hidden"
                      >
                        <div className="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center group-hover:bg-primary/20 transition-colors relative z-10">
                        ...
                        <div className="absolute bottom-0 left-0 w-full leading-none">
                          <svg viewBox="0 0 1200 120" className="block w-full h-10" preserveAspectRatio="none" aria-hidden="true">
                            <path
                              d="M0,48L60,58.7C120,69,240,91,360,90.7C480,91,600,69,720,58.7C840,48,960,48,1080,58.7L1200,69V120H1080C960,120,840,120,720,120C600,120,480,120,360,120C240,120,120,120,60,120H0Z"
                              className="fill-primary/15"
                            />
                  ...
                  <a
                    ...
                    className="flex items-center gap-4 p-6 pb-14 bg-green-500/10 border border-green-500/20 rounded-xl hover:bg-green-500/20 transition-all relative overflow-hidden"
                  >
                    <div className="w-12 h-12 rounded-xl bg-green-500 flex items-center justify-center relative z-10">
